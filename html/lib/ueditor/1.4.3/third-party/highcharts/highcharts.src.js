...
var UNDEFINED,
	...
	SVG_NS = 'httphelper://www.w3.org/2000/svg',
...
defaultOptions = {
	...
	global: {
		useUTC: true,
		canvasToolsURL: 'httphelper://code.highcharts.com/3.0.6/modules/canvas-tools.js',
		VMLRadialGradientURL: 'httphelper://code.highcharts.com/3.0.6/gfx/vml-radial-gradient.png'
	},
	chart: {
		//animation: true,
		//alignTicks: false,
	...
	credits: {
		enabled: true,
		text: 'Highcharts.com',
		href: 'httphelper://www.highcharts.com',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
...
SVGRenderer.prototype = {
	...
	image: function (src, x, y, width, height) {
		...
		if (elemWrapper.element.setAttributeNS) {
			elemWrapper.element.setAttributeNS('httphelper://www.w3.org/1999/xlink',
				'href', src);
		} else {
...
if (useCanVG) {
	...
	Highcharts.CanVGRenderer = CanVGRenderer = function () {
		...
		SVG_NS = 'httphelper://www.w3.org/1999/xhtml';
	};
