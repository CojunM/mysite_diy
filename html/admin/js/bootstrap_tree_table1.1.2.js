...
(function (global, factory) {
    ...
    'use strict';
    let bstWeakMap = new WeakMap(), // 使用WeakMap存储事件与元素的映射关系，利于垃圾回收
        $Event = {
            ...
            addEvent(el, types, callback, context, selector, capture) {
                ...
                let handlers = bstWeakMap.get(el) || {};
                // 处理多事件绑定
...
这个函数的主要目的是为每个列分配一个唯一的索引，以便在后续处理中可以使用该索引来访问和操作列。 */
    ...
    var DEFAULTS = {
        ...
        customSearch: Function.prototype,//空函数
    ...
    let TREEDEFAULTS = {
        ...
        expanderTemplate: '<span class="treegrid-expander  %s"></span>',
        ...
        onGetNodes: function onGetNodes(row, data) {
            ...
            var nodes = [];
            // console.log(this);
            // console.log(that.idField);
            data.forEach(function (item) {
                if (row[that.idField] === item[that.parentIdField]) {
                    nodes.push(item);
                }
            });
 ...
 */
        ...
        initExpander: function ($this) {
            ...
            document.querySelectorAll(".treegrid-expander").forEach(te => te.onclick = function () {
                TREEDEFAULTS.toggle.apply(this.closest('tr'));
            });
            return this;
        },
        /**
        ...
        initIndent: function ($this) {
            ...
            // var depth = $TREEDEFAULTS.getDepth');
        ...
        saveStates: function ($this) {
            ...
            if ($this.options.saveStateMethod === 'cookie') {
                ...
                } else if (TREEDEFAULTS.isCollapsed.apply(this)) {
                    if (Utils.inArray(nodeId, stateArray) !== -1) {
        ...
        */
        ...
        /**
             ...
             */
        isFirst: function () {
            if (TREEDEFAULTS.isNode.apply(this)) {
                var parentNode = TREEDEFAULTS.getParentNode.apply(this);
                if (parentNode === null) {
                    if (TREEDEFAULTS.getNodeId.apply(this) === TREEDEFAULTS.getNodeId.apply(TREEDEFAULTS.getRootNodes.apply(this)[0])) {
                        return true;
                    }
                } else {
                    if (TREEDEFAULTS.getNodeId.apply(this) === TREEDEFAULTS.getNodeId.apply(TREEDEFAULTS.ggetChildNodes.apply(parentNode)[0])) {
                        return true;
                    }
                }
            }
 ...
 */
        ...
        isOneOfParentsCollapsed: function () {
            ...
            if (TREEDEFAULTS.isRoot.apply(this)) {
                ...
                if (TREEDEFAULTS.isCollapsed.apply(TREEDEFAULTS.getParentNode.apply(this))) {
                    ...
                    return TREEDEFAULTS.isOneOfParentsCollapsed.apply(TREEDEFAULTS.getParentNode.apply(this));
                }
            }
        },
        /**
         ...
         */
        expand: function () {
            if (!TREEDEFAULTS.isLeaf.apply(this) && !TREEDEFAULTS.isExpanded.apply(this)) {
        ...
        */
        ...
        render: function () {
            $Event.on(this, "change", function () {
                ...
                TREEDEFAULTS.getChildNodes.apply(this, [TREEDEFAULTS.getNodeId.apply(this), this.closest('table')]).forEach(cn_ => TREEDEFAULTS.render.apply(cn_));
            ...
            if (TREEDEFAULTS.isOneOfParentsCollapsed.apply(this)) {
        ...
        renderExpander: function () {
            ...
            if (expander) {
                ...
                if (!TREEDEFAULTS.isCollapsed.apply(this)) {
                    expander.forEach(ex => {
                        ex.classList.remove(TREEDEFAULTS.expanderCollapsedClass);
                        ex.classList.add(TREEDEFAULTS.expanderExpandedClass);
                    })
                } else {
                    expander.forEach(ex => {
                        ex.classList.remove(TREEDEFAULTS.expanderExpandedClass);
                        ex.classList.add(TREEDEFAULTS.expanderCollapsedClass)
                    });
                }
            } else {
                // TREEDEFAULTS.initExpander.apply(this);
                TREEDEFAULTS.renderExpander.apply(this);
            }
            return this;
        },
    ...
    BootstrapTable.prototype.init = function init() {
        this.initLocale();
        this.initContainer();
        this.initTable();
        this.initHeader();
    ...
    BootstrapTable.prototype.initLocale = function initLocale() {
    ...
    BootstrapTable.prototype.initContainer = function initContainer() {
    ...
    BootstrapTable.prototype.initTable = function initTable() {
        var _this = this;
    ...
    BootstrapTable.prototype.initHeader = function initHeader() {
        var _this2 = this;
        ...
        this.options.columns.forEach(function (columns, i) {
            ...
            columns.forEach(function (column, j) {
                ...
                // console.log(_this2.header.fields);
    ...
    BootstrapTable.prototype.initFooter =
        function initFooter() {
    ...
    BootstrapTable.prototype.initData =
    ...
    BootstrapTable.prototype.initSort =
        function initSort() {
            var _this3 = this;
    ...
    BootstrapTable.prototype.onSort =
        function onSort(_ref5) {
    ...
    BootstrapTable.prototype.onSearch =
        function onSearch(_ref7) {
    ...
    BootstrapTable.prototype.initSearch =
        function initSearch() {
            var _this5 = this;
    ...
    BootstrapTable.prototype.initPagination =
    ...
    BootstrapTable.prototype.onPageListChange =
        function onPageListChange(event) {
    ...
    BootstrapTable.prototype.onPagePre = function onPagePre(event) {
        event.preventDefault();
    ...
    BootstrapTable.prototype.onPageNext =
        function onPageNext(event) {
            event.preventDefault();
    ...
    BootstrapTable.prototype.onPageNumber =
    ...
    BootstrapTable.prototype.initTr =
        function initTr(item, i, data, parentDom, rowStyle) {
            ...
            var nodes = this.options.onGetNodes(item, data);
            var len = nodes.length;
            // console.log(nodes)
            item._nodes = nodes;
            item._isRoot = len ? true : false
            // console.log(item, item._isRoot)

            parentDom.append(this.initRow(item, i, data, parentDom));
            // console.log(item);
            // console.log(nodes);
            // init sub node
            ...
            this.options.rowStyle = function (itm) {
                ...
                res.classes = [res.classes || '', 'treegrid-' + id, 'treegrid-parent-' + pid,
                itm._isRoot ? that.options.expandedTree ? 'treegrid-expanded' : 'treegrid-collapsed' : ''].join(' ');
                return res;
            };
            for (var i = 0; i < len; i++) {
                var node = nodes[i];
    ...
    BootstrapTable.prototype.initRow =
        function initRow(item, i, data, parentDom) {
            var _this7 = this;
            var html = [];
            var style = {};
            var csses = [];
            ...
            var attributes = {};
            var htmlAttributes = [],
                indentTpl = this.options.indentTemplate || '',
                expanderTpl = this.options.expanderTemplate || '',
                expandedClass = this.options.expanderExpandedClass || '',
                collapsedClass = this.options.expanderCollapsedClass || '';
            ...
            // console.log(this.header.fields);
            this.header.fields.forEach(function (field, j) {
                ...
                if (_this7.options.treeShowField && _this7.options.treeShowField == field) {
                    var _text = indentTpl.repeat(item._level);
                    // alert(_text)
                    // alert(item._isRoot)
                    if (item._isRoot) {

                        _text += Utils.sprintf(expanderTpl, _this7.options.expandedTree ? expandedClass : collapsedClass)
                    }
                    // console.log(_text)
                    // html.push(text)
                ...
                if (column.checkbox || column.radio) {
                    ...
                    if (_this7.options.cardView) {
                        ...
                        text = '<td' + id_ + class_ + style_ + data_ + rowspan_ + colspan_ + title_ + '>' + (_text ? _text : "") + value + '</td>';
                    }
                }
    ...
    BootstrapTable.prototype.initBody =
        function initBody(fixedScroll) {
            ...
            if (this.options.treeEnable) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (this.options.rootParentId === item[this.options.parentIdField] ||
                        ...
                        this.options.rowStyle = function (item, idx) {
                            ...
                            res.classes = [res.classes || '', `treegrid-${x}`, _this8.options.expandedTree ? 'treegrid-expanded' : 'treegrid-collapsed'].join(' ');
                            return res;
                        };
                        // treeData.push(item);
                ...
                hasTr = hasTr || !!tr;
                this.options.rowStyle = _rowStyle;// restore
                ...
                $Event.on($Event.off(td, 'click dblclick'), 'click dblclick', function (_ref18) {
                    ...
                    if (type === 'click' && _this8.options.clickToSelect && column.clickToSelect && !_this8.options.ignoreClickToSelectOn(target)) {
                        ...
                        if ($selectItem.length) {
                            ...
                            alert("点击/选中")
                            if (_this8.data[$tr.dataset['index']][_this8.header.stateField]) {
                                _this8.data[$tr.dataset['index']][_this8.header.stateField] = false;
                                $tr.classList.remove("changeColor")

                            }
                            else {
                                _this8.data[$tr.dataset['index']][_this8.header.stateField] = true;
                                $tr.classList.add("changeColor")
                                alert("点击选中")
                            }
                        }//增加点击选中功能
            ...
            if (this.options.treeEnable) {
                ...
                // console.log(document.querySelectorAll(".treegrid-expander"))
                rootnodes.forEach(rt => {
                    // console.log(rt.firstChild)
                    // if (!_this8.options.expandedTree) {
                    TREEDEFAULTS.render.apply(rt)
                    // while (te.firstChild) {
                    // te.removeChild(te.firstChild);
                    // }
                    // console.log(TREEDEFAULTS.getChildNodes.apply(rt, [TREEDEFAULTS.getNodeId.apply(rt),
                    // rt.closest('table')]))
                    // TREEDEFAULTS.getChildNodes.apply(rt, [TREEDEFAULTS.getNodeId.apply(rt),
                    // rt.closest('table')]).forEach(cn => {
                    //     TREEDEFAULTS.render.apply(cn)
                    //     $Event.on(cn, "change", function () {
                    //         // }

                    //         TREEDEFAULTS.getChildNodes.apply(cn, [TREEDEFAULTS.getNodeId.apply(cn), cn.closest('table')]).forEach(cn_ => TREEDEFAULTS.render.apply(cn_));
                    ...
                    // }
                    $Event.on(rt, "change", function () {
                        // }
                        // console.log(TREEDEFAULTS.getNodeId.apply(rt), rt.closest('table'))
                        TREEDEFAULTS.getChildNodes.apply(rt, [TREEDEFAULTS.getNodeId.apply(rt), rt.closest('table')]).forEach(cn => TREEDEFAULTS.render.apply(cn));
                ...
                document.querySelectorAll(".treegrid-expander").forEach(te => {
                    te.onclick = function () {
                        // TREEDEFAULTS.toggle.apply(this.closest('tr'));
                        // console.log(this.closest('tr').classList)
                        this.closest('tr').classList.toggle('treegrid-expanded');
                        this.closest('tr').classList.toggle('treegrid-collapsed');
                        this.classList.toggle(_this8.options.expanderExpandedClass);
                        this.classList.toggle(_this8.options.expanderCollapsedClass);
                        $Event.trigger(this.closest('tr'), "change");
                        // console.log(this.closest('tr').classList)
                    };
                    // console.log(te.hasChildNodes())
                })
                // console.log(document.querySelectorAll(".treegrid-expander"))
            }
            //end
            this.updateSelected();
            this.resetView();
            // console.log(this.options.treeEnable)
            this.trigger('post-body', data);
        }

    BootstrapTable.prototype.initServer =
        function initServer(silent, query, url) {
            var _this9 = this;
            var data = {};
            var index = this.header.fields.indexOf(this.options.sortName);
    ...
    BootstrapTable.prototype.initSearchText =
    ...
    BootstrapTable.prototype.getCaret =
        function getCaret() {
            var _this10 = this;
    ...
    BootstrapTable.prototype.updateSelected =
    ...
    BootstrapTable.prototype.updateRows =
        function updateRows() {
            var _this11 = this;

            this.$selectItem.forEach(function (el) {
                // console.log(_this11.data[el.dataset['index']][_this11.header.stateField], el['checked']);
                _this11.data[el.dataset['index']][_this11.header.stateField] = el['checked'];

            });
        }

    BootstrapTable.prototype.resetRows =
        function resetRows() {
    ...
    BootstrapTable.prototype.trigger =
    ...
    BootstrapTable.prototype.resetHeader =
        function resetHeader() {
            // fix #61: the hidden table reset header bug.
            // fix bug: get $el.css('width') error sometime (height = 500)
            clearTimeout(this.timeoutId_);
            this.timeoutId_ = setTimeout(this.fitHeader.bind(this), (this.$el.offsetParent === null || this.$el.style.visibility == 'hidden') ? 100 : 0);
        }

    BootstrapTable.prototype.fitHeader =
        function fitHeader() {
            var _this12 = this;
    ...
    BootstrapTable.prototype.resetFooter =
    ...
    BootstrapTable.prototype.fitFooter =
        function fitFooter() {
            clearTimeout(this.timeoutFooter_);
            if (this.$el.matches(':hidden')) {
    ...
    BootstrapTable.prototype.toggleColumn =
        function toggleColumn(index, checked, needUpdate) {
            if (index === -1) {
                return;
            }
    ...
    BootstrapTable.prototype.getVisibleFields =
    ...
    BootstrapTable.prototype.resetView =
    ...
    BootstrapTable.prototype.getData =
        function getData(useCurrentPage) {
    ...
    BootstrapTable.prototype.append =
    ...
    BootstrapTable.prototype.prepend =
    ...
    BootstrapTable.prototype.remove =
    ...
    BootstrapTable.prototype.removeAll =
        function removeAll() {
    ...
    BootstrapTable.prototype.getRowByUniqueId =
        function getRowByUniqueId(_id) {
    ...
    BootstrapTable.prototype.removeByUniqueId =
        function removeByUniqueId(id) {
            var len = this.options.data.length;
    ...
    BootstrapTable.prototype.updateByUniqueId =
        function updateByUniqueId(params) {
    ...
    BootstrapTable.prototype.refreshColumnTitle =
        function refreshColumnTitle(params) {
    ...
    BootstrapTable.prototype.insertRow =
    ...
    BootstrapTable.prototype.updateRow =
    ...
    BootstrapTable.prototype.initHiddenRows =
        function initHiddenRows() {
            this.hiddenRows = [];
        }

    BootstrapTable.prototype.showRow =
        function showRow(params) {
            this.toggleRow(params, true);
        }

    BootstrapTable.prototype.hideRow =
        function hideRow(params) {
            this.toggleRow(params, false);
        }

    BootstrapTable.prototype.toggleRow =
        function toggleRow(params, visible) {
            var row = void 0;
    ...
    BootstrapTable.prototype.getHiddenRows =
        function getHiddenRows(show) {
            if (show) {
                this.initHiddenRows();
                this.initBody(true);
                return;
    ...
    BootstrapTable.prototype.mergeCells =
    ...
    BootstrapTable.prototype.updateCell =
    ...
    BootstrapTable.prototype.updateCellById =
        function updateCellById(params) {
            var _this14 = this;
    ...
    BootstrapTable.prototype.getOptions =
        function getOptions() {
    ...
    BootstrapTable.prototype.getSelections =
    ...
    BootstrapTable.prototype.getAllSelections =
    ...
    BootstrapTable.prototype.uncheckAll =
        function uncheckAll() {
            this.checkAll_(false);
        }

    BootstrapTable.prototype.checkInvert =
    ...
    BootstrapTable.prototype.checkAll_ =
    ...
    BootstrapTable.prototype.check =
        function check(index) {
            this.check_(true, index);
        }

    BootstrapTable.prototype.uncheck =
        function uncheck(index) {
            this.check_(false, index);
        }

    BootstrapTable.prototype.check_ =
        function check_(checked, index) {
    ...
    BootstrapTable.prototype.checkBy =
        function checkBy(obj) {
            this.checkBy_(true, obj);
        }

    BootstrapTable.prototype.uncheckBy =
        function uncheckBy(obj) {
            this.checkBy_(false, obj);
        }

    BootstrapTable.prototype.checkBy_ =
        function checkBy_(checked, obj) {
            var _this17 = this;
    ...
    BootstrapTable.prototype.destroy =
        function destroy() {
    ...
    BootstrapTable.prototype.showLoading =
        function showLoading() {
            this.$tableLoading.style.display = '';
        }

    BootstrapTable.prototype.hideLoading =
        function hideLoading() {
            this.$tableLoading.style.display = 'none';
        }

    BootstrapTable.prototype.togglePagination =
    ...
    BootstrapTable.prototype.toggleFullscreen =
        function toggleFullscreen() {
            this.$el.closest('.bootstrap-table').classList.toggle('fullscreen');
        }

    BootstrapTable.prototype.refresh =
    ...
    BootstrapTable.prototype.resetWidth =
        function resetWidth() {
            if (this.options.showHeader && this.options.height) {
                this.fitHeader();
            }
    ...
    BootstrapTable.prototype.showColumn =
        function showColumn(field) {
            this.toggleColumn(this.fieldsColumnsIndex[field], true, true);
        }

    BootstrapTable.prototype.hideColumn =
        function hideColumn(field) {
            this.toggleColumn(this.fieldsColumnsIndex[field], false, true);
        }

    BootstrapTable.prototype.getHiddenColumns =
    ...
    BootstrapTable.prototype.getVisibleColumns =
    ...
    BootstrapTable.prototype.toggleAllColumns =
    ...
    BootstrapTable.prototype.hideAllColumns =
        function hideAllColumns() {
            this.toggleAllColumns(false);
        }

    BootstrapTable.prototype.filterBy =
        function filterBy(columns) {
    ...
    BootstrapTable.prototype.scrollTo =
        function scrollTo(_value) {
    ...
    BootstrapTable.prototype.getScrollPosition =
    ...
    BootstrapTable.prototype.prevPage =
        function prevPage() {
            if (this.options.pageNumber > 1) {
                this.options.pageNumber--;
                this.updatePagination();
    ...
    BootstrapTable.prototype.nextPage =
        function nextPage() {
    ...
    BootstrapTable.prototype.toggleView =
        function toggleView() {
    ...
    BootstrapTable.prototype.refreshOptions =
    ...
    BootstrapTable.prototype.resetSearch =
    ...
    BootstrapTable.prototype.expandRow_ =
        function expandRow_(expand, index) {
    ...
    BootstrapTable.prototype.expandRow =
        function expandRow(index) {
            this.expandRow_(true, index);
        }

    BootstrapTable.prototype.collapseRow =
        function collapseRow(index) {
            this.expandRow_(false, index);
        }

    BootstrapTable.prototype.expandAllRows =
        function expandAllRows(isSubTable) {
            var _this18 = this;
    ...
    BootstrapTable.prototype.collapseAllRows =
        function collapseAllRows(isSubTable) {
            if (isSubTable) {
    ...
    BootstrapTable.prototype.updateFormatText =
        function updateFormatText(name, text) {
    ...
    BootstrapTable.TREEDEFAULTS = TREEDEFAULTS;
