...
from brick.apps.wsgiapp import get, put, delete, post
from brick.contrib import convert_helper, web_helper
...
def callback():
    ...
    fields = {
        ...
        'department_code': str(department_result.get('code', '')),
        'department_name': str(department_result.get('name', '')),
        'page_power': str(page_power),
    }
    # 读取记录
