...
class ModelSelect(BaseModelSelect, Select):
    ...
    def _normalize_join(self, src, dest, on, attr):
        ...
        # Obtain references to the source and destination model being joined.
...
class ModelCursorWrapper(BaseModelCursorWrapper):
    ...
    def process_row(self, row):
        ...
        # When instantiating model from a cursor, we clear the dirty fields.
