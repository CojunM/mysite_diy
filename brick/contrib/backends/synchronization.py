...
from brick.contrib.caches.exceptions import LockError
...
class FileSynchronizer(SynchronizerImpl):
    ...
    def __init__(self, identifier, lock_dir):
        ...
        self._filedescriptor = utils.ThreadLocal()
        ...
        self.filename = utils.encoded_path(
                            lock_dir,
                            [identifier],
                            extension='.lock'
                        )
